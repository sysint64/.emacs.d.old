...
(global-set-key (kbd "C-b 1") 'bookmark-set-1)
(global-set-key (kbd "C-b 2") 'bookmark-set-2)
(global-set-key (kbd "C-b 3") 'bookmark-set-3)
(global-set-key (kbd "C-b 4") 'bookmark-set-4)
(global-set-key (kbd "C-b 5") 'bookmark-set-5)
(global-set-key (kbd "C-b 6") 'bookmark-set-6)
(global-set-key (kbd "C-b 7") 'bookmark-set-7)
(global-set-key (kbd "C-b 8") 'bookmark-set-8)
(global-set-key (kbd "C-b 9") 'bookmark-set-9)
(global-set-key (kbd "C-b 0") 'bookmark-set-0)
...
(global-set-key (kbd "C-j 1") 'bookmark-jump-1)
(global-set-key (kbd "C-j 2") 'bookmark-jump-2)
(global-set-key (kbd "C-j 3") 'bookmark-jump-3)
(global-set-key (kbd "C-j 4") 'bookmark-jump-4)
(global-set-key (kbd "C-j 5") 'bookmark-jump-5)
(global-set-key (kbd "C-j 6") 'bookmark-jump-6)
(global-set-key (kbd "C-j 7") 'bookmark-jump-7)
(global-set-key (kbd "C-j 8") 'bookmark-jump-8)
(global-set-key (kbd "C-j 9") 'bookmark-jump-9)
(global-set-key (kbd "C-j 0") 'bookmark-jump-0)
